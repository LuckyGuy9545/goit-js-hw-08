...
Для этого добавь в проект и используй библиотеку lodash.throttle. */ //== (4)
...
function populateTextarea() {
    const formData1 = JSON.parse(localStorage.getItem(localFeedBackKey)) || {};
    if (formData1) {
        refs.email.value = formData1.email;
        refs.message.value = formData1.message;
    }
}
